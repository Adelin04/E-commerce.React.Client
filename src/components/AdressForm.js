        ...
        <div className=' flex justify-center items-center w-full h-full m-2'>
            ...
            <Form className='flex flex-col justify-between items-center w-full h-full p-1' noValidate validated={validated} onSubmit={handleSubmit}>
                ...
                <div className='flex flex-col w-[80%]'>
                    <h3 className='flex justify-center items-center  w-full p-1   font-bold text-[20px]'>Delivery Address</h3>
                ...
                <Row className="flex flex-col justify-center items-center mb-4 w-full m-3">
                    ...
                    <Form.Group as={Col} md="6" controlId="validationCustom03" className='flex flex-col justify-center items-center  w-[50%] my-2 mx-2 p-1'>
                        ...
                        <Form.Control type="text" placeholder="City" required className='flex justify-center items-center  w-full my-auto mx-2 p-1' />
                    </Form.Group>

                    <Form.Group as={Col} md="3" controlId="validationCustom04" className='flex flex-col justify-center items-center  w-[50%] my-2 mx-2 p-1'>
                        ...
                        <Form.Control type="text" placeholder="State" required className='flex flex-col justify-center items-center  w-full my-auto mx-2 p-1' />
                    </Form.Group>

                    <Form.Group as={Col} md="3" controlId="validationCustom05" className='flex flex-col justify-center items-center  w-[50%] my-2 mx-2 p-1'>
                        ...
                        <Form.Control type="text" placeholder="Zip" required className='flex flex-col justify-center items-center  w-full my-auto mx-2 p-1' />
                    </Form.Group>

                    <Form.Group as={Col} md="3" controlId="validationCustom06" className='flex flex-col justify-center items-center  w-[50%] my-2 mx-2 p-1'>
                        {/* <Form.Control.Feedback type="invalid" className='flex justify-center items-center  w-full my-auto mx-2 p-1'>Please provide a valid zip.</Form.Control.Feedback> */}
                    ...
                    <div className='acord-terms-footer flex flex-col justify-center items-start text-center h-10 w-[50%] m-auto p-1'>
                        <Link to={'/termsAndCondition'} className="flex justify-center items-center text-red-400 w-max h-max hover:border-b-2 hover:border-red-400">Read the terms and conditions</Link>
                    </div>

    ...
    <div className="flex flex-col h-full w-full justify-between items-center">
      ...
      <div className="flex flex-col w-full h-full justify-between items-center">
        <div className="wrpper-title min-[450px]:flex w-full m-auto justify-center items-center text-center">
          <h3 className="title-1st-child text-[35px] font-semibold my-1">
            Shopping Cart{" "}
          </h3>
          <h3
            className="title-2st-child text-[35px] my-1 mx-10"
                    ...
                    {product &&
                      product.quantityPerSize.map((item, indexItem) => {
                        return (
                          <div
                            key={indexItem}
                            className="wrapper-product flex flex-row justify-center items-center w-full h-full m-1 p-1"
                          >
                            {item.quantity > 0 && (
                              <li className="list list-none flex flex-row justify-between items-center w-11/12 h-max my-3">
                                ...
                                <div className="wrapper-price flex justify-center items-center min-w-11 h-max p-1 m-1 text-[20px] font-bold">
                                  <span className="price flex justify-center items-center p-1 w-auto">
                                    {
                                      <PriceFormated
                                  ...
                                  <span className="currency flex justify-center items-center p-1 w-auto">
                                    {currency}
                                  </span>
                                </div>
        ...
        <div className="wrapper-cardToPlay-cart flex flex-col justify-end w-full">
          ...
          <div className="nextStep-link-cart flex w-auto h-auto mx-auto my-2 p-1 justify-center items-center ">
            <Link
              to={shoppingCartList.length > 0 ? `/address` : `/cart`}
